...
import com.aaar.vinapp.UpdateAsyncTask;
...
public class EditTopicNewActivity extends AppCompatActivity {
        ...
        fabsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentTopic.getTopic().isEmpty()) {
                    Toast.makeText(EditTopicNewActivity.this, "Please Enter a topic Name", Toast.LENGTH_LONG).show();
                }
                else {
                    if (currentTopic.getLink().isEmpty()) {
                        ...
                        if(Patterns.WEB_URL.matcher(currentTopic.getLink()).matches() && URLUtil.isValidUrl(currentTopic.getLink())){
                            ...
                            Toast.makeText(EditTopicNewActivity.this, "Please Enter a Valid URL", Toast.LENGTH_LONG).show();
                        }
                    }
                }
            }
